            ...
            <header className="landing-hero" style={{ paddingBottom: '60px', paddingTop: '150px' }}>
                ...
                <div className="landing-container relative z-10 text-center">
                    ...
                    <p className="landing-section-subtitle">
                        Have questions about VTPay? Our team is here to help you scale your VTU business.
                    </p>
                </div>
            </header>
                        ...
                        <div className="landing-feature-card">
                            ...
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500">support@vtpay.com.ng</p>
                                    <p className="text-gray-500">sales@vtpay.com.ng</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500">+234 800 VTPAY HELP</p>
