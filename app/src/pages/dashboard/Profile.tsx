...
import { User, Mail, Phone, Camera, Briefcase, Lock, Shield, CheckCircle, AlertCircle, Loader2, ChevronRight, ShieldAlert, Award } from 'lucide-react';
...
export const Profile: React.FC = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6 md:space-y-8 pb-10 animate-fade-in p-4 md:p-6">
            {/* Header */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 md:p-6 rounded-2xl border border-gray-100 shadow-sm relative overflow-hidden">
                ...
                <div className="absolute top-0 right-0 w-64 h-64 bg-primary-100/50 rounded-full blur-3xl opacity-50 -translate-y-1/2 translate-x-1/3"></div>

                <div className="flex p-1 bg-gray-100 rounded-xl self-start sm:self-center relative z-10">
                    <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Left Sidebar - Profile Summary & Verification */}
                        ...
                        <div className="p-6">
                            ...
                            {(user?.kycLevel || 0) < 2 ? (
                                ...
                                <div className="bg-primary-50 rounded-xl p-4 border border-primary-100">
                                    ...
                                    <button
                                        onClick={() => navigate('/dashboard/verification')}
                                        className="w-full py-2.5 bg-primary-600 hover:bg-primary-700 text-white text-xs font-bold rounded-lg transition-colors shadow-lg shadow-primary-200 flex items-center justify-center gap-2"
                                    >
                                ...
                                <div className="bg-green-50 rounded-xl p-4 border border-green-100">
                                    ...
                                    >
                                        Upgrade / View Details <ChevronRight size={14} />
                                    </button>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                            <div className="p-5 md:p-6 border-b border-gray-100 bg-gray-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                ...
                                <button
                                    ...
                                    className={`w-full sm:w-auto px-6 py-2.5 rounded-xl text-xs md:text-sm font-black transition-all uppercase tracking-widest ${isEditing ? 'bg-gray-100 text-gray-700 hover:bg-gray-200' : 'bg-primary-600 text-white hover:bg-primary-700 shadow-lg shadow-primary-200'}`}
                                >
                            ...
                            <div className="p-5 md:p-8">
                                <form onSubmit={handleSaveProfile} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative group">
                                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                                <Briefcase className="h-5 w-5 text-gray-400 group-focus-within:text-primary-600 transition-colors" />
                                            </div>
                                            <input
                                                type="text"
                                                name="businessName"
                                    ...
                                    {isEditing && (
                                        <div className="pt-6 flex justify-end border-t border-gray-100 mt-8">
                                            <button
                                                type="submit"
                                                disabled={isLoading}
                                                className="w-full sm:w-auto px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white rounded-xl md:rounded-2xl font-black text-sm transition-all shadow-xl shadow-primary-200 flex items-center justify-center gap-3 transform hover:-translate-y-1 active:translate-y-0"
                                            >
                                                {isLoading ? (
                                                    <Loader2 size={20} className="animate-spin" />
                                                ) : (
                                ...
                                <form onSubmit={handleUpdatePassword} className="space-y-6 max-w-lg">
                                    <div>
                                        ...
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-11 pr-4 py-3.5 bg-gray-50 border-2 border-gray-100 rounded-xl md:rounded-2xl text-sm md:text-base font-bold text-gray-900 focus:outline-none focus:border-primary-500 transition-all"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <div className="relative group">
                                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                                    <Shield className="h-5 w-5 text-gray-400 group-focus-within:text-primary-600 transition-colors" />
                                                </div>
                                                <input
                                                    type="password"
                                                    name="new"
