    ...
    async sendWalletAdjustmentOtp(otp) {
        ...
        const html = `
            <div style="font-family: sans-serif; padding: 20px; border: 1px solid #eee; border-radius: 10px; max-width: 600px; margin: 0 auto; border-top: 4px solid #ef4444;">
                ...
                <p>A manual wallet adjustment (Correction) is being initiated on ${companyName}.</p>
                <p>Use the following authorization code to complete the operation:</p>
                <div style="margin: 30px 0; font-size: 36px; font-weight: 800; letter-spacing: 10px; color: #111827; text-align: center; background: #fee2e2; padding: 20px; border-radius: 12px;">
                    ${otp}
                </div>
                <p style="color: #666; font-size: 13px; font-weight: bold;">⚠️ If you did not initiate this, please secure your admin account immediately.</p>
                <p style="color: #999; font-size: 11px;">Expires in 5 minutes.</p>
            </div>
        `;
