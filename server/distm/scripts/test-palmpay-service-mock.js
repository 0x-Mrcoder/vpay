...
class MockAxios {
    ...
    mockResponse(urlFragment, responseData) {
...
async function runTests() {
    ...
    const service = new PalmPayService_1.PalmPayService(mockClient);
    ...
    try {
        ...
        if (result.virtualAccountNo === '1234567890') {
...
runTests();
//# sourceMappingURL=test-palmpay-service-mock.js.map